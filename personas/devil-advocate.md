...
Search for:
- `"[keywords] startup failed"` or `"[keywords] why it failed"`
- `"[keywords] alternatives"` or `"best [keywords] tools"`
- Post-mortems: Indie Hackers, Hacker News, CB Insights shutdown database
- `"[keywords] free"` — is there a free tier of an existing product that kills the market?

## Output

Score overall risk 1–10 (10 = extremely high risk / likely fatal flaw found). Lead with the most damning finding. Be blunt — this is the most important perspective.
